...
public class BeanUtil {
	...
	private static Object getValueByField(Cursor cursor,String columnName, Field field){
		...
		else if (fieldClass == Long.class) return cursor.getLong(index);

		else if (fieldClass == Double.class) return cursor.getDouble(index);

		else if (fieldClass == Float.class) return cursor.getFloat(index);

		else if (fieldClass == Short.class) return cursor.getShort(index);
